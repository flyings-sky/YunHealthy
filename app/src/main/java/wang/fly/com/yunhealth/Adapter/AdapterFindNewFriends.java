...
public class AdapterFindNewFriends extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            viewHolder.imUserHead = (ImageView) convertView.findViewById(R.id.id_item_find_new_friends_pic);
            viewHolder.tvUserName = (TextView) convertView.findViewById(R.id.id_item_find_new_friends_name);
            viewHolder.btAddFriend = (Button) convertView.findViewById(R.id.id_item_find_new_friends_add);
        ...
        viewHolder.btAddFriend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(v.isEnabled()){
                    ...
                    friendApply.put("objId",AVUser.getCurrentUser().getObjectId());
